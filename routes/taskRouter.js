...
import schema from '../schemas/taskSchemas.js';
...
taskRouter.post("/", userValidators.authenticate, isEmptyBody, validateBody(schema.taskSchema), taskControllers.addTask);

taskRouter.put("/:taskId", userValidators.authenticate, isEmptyBody, validateBody(schema.taskSchema), taskControllers.updateTask);
